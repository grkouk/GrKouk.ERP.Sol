    ...
    public partial class SyncEntitiesPart1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyncBuyDocument", x => new { x.ErpId, x.BusId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyncSaleDocument", x => new { x.ErpId, x.BusId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyncSuppliers", x => new { x.ErpId, x.BusId });
                });
