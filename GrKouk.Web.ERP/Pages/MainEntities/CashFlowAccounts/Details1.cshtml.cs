...
namespace GrKouk.Web.Erp.Pages.MainEntities.CashFlowAccounts
{
    ...
    public class DetailsModel1 : PageModel
    {
        ...
        public DetailsModel1(ApiDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            var transactor = await _context.CashFlowAccounts
            ...
            var compList = transactor.CompanyMappings.Select(x => x.Company.Code).ToList();
